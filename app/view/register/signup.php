               ...
               <div class="row">
                  ...
                  <div class="col-md-5 col-md-offset-1">
                     ...
                     <div class="wrap-login100">
                           <form class="login100-form validate-form" action='<?= URLROOT ?>SignupController/insert' method='POST'>  
                              <span class="login100-form-title "> <?= lang('SIGNUP') ?> </span> 
                              <span class="login100-form-subtitle m-b-16"> <?= lang('TO MAKE AN ACCOUNT') ?></span>
                              ...
                              <div class="wrap-input100 validate-input m-b-16"> 
                                 <input class="input100" type="text" name="E-mail" placeholder="<?= lang('E-MAIL') ?>"> 
                                 <span class="focus-input100"></span> 
                                 <span class="symbol-input100"> 
                                    <span class="glyphicon glyphicon-lock"></span> 
                                 </span> 
                              ...
                              <div class="wrap-input100 validate-input m-b-16"> 
                                 <input class="input100" type="text" name="fullname" placeholder="<?= lang('FULLNAME') ?>"> 
                                 <span class="focus-input100"></span> 
                                 <span class="symbol-input100"> 
                                    <span class="glyphicon glyphicon-lock"></span> 
                                 </span> 
                              ...
                              <div class="flex-sb-m w-full p-b-30">
                                 <div> <a href="<?= URLROOT ?>IndexController/login" class="txt1"> <?= lang('HAVE AN ACCOUNT') ?> <?= lang('?') ?> <?= lang('LOGIN') ?> </a> </div>
                              </div>
