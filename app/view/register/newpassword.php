               ...
               <div class="row">
                  ...
                  <div class="col-md-5 col-md-offset-1">
                     ...
                     <div class="wrap-login100">
                           <form class="login100-form validate-form" action='<?= URLROOT ?>ForgetpasswordController/changePassword' method='POST'>  
                              <span class="login100-form-subtitle m-b-16"> <?= lang('ENTER THE NEW PASSWORD') ?> </span> 
                              <div class="wrap-input100 validate-input m-b-16">
                                  <input class="input100" type="text" name="password" placeholder="<?= lang('NEW PASSWORD') ?>">
                              ...
                              <div class="container-login100-form-btn p-t-25"> 
                                 <button class="login100-form-btn" type='submit'> <?= lang('SAVE') ?> </button> 
                              </div>
