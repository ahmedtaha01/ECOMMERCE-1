               ...
               <div class="row">
                  ...
                  <div class="col-md-5 col-md-offset-1">
                     ...
                     <div class="wrap-login100">
                           <form class="login100-form validate-form" action='<?= URLROOT ?>ForgetpasswordController/checkNumber' method='POST'>  
                              <span class="login100-form-subtitle m-b-16"> <?= lang('THE NUMBER PLEASE') ?> </span> 
                              <div class="wrap-input100 validate-input m-b-16">
                                  <input class="input100" type="text" name="num" placeholder="<?= lang('ENTER THE NUMBER SENT TO YOUR EMAIL') ?>">
